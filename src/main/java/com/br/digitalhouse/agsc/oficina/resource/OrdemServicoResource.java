...
import com.br.digitalhouse.agsc.oficina.service.OrdemServicoService;
...
public class OrdemServicoResource {
	...
	@PostMapping
	public ResponseEntity<?> create( @RequestBody OrdemServico ordemServico){
	...
	public ResponseEntity<List<OrdemServico>> findAll(){
		List<OrdemServico> ordemServicos = this.ordemServicoService.findAll();
